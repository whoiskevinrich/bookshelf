...
export function AppHeader({ activePage }: AppHeaderProps) {
  ...
  const inactiveLinkClass = "text-sm text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white";
  ...
  return (
    <header className="border-b border-slate-100 dark:border-slate-800 px-6 py-4 flex items-center justify-between bg-white dark:bg-slate-900 transition-colors">
      ...
      <nav className="flex items-center gap-4">
        ...
        <Link to="/wishlist" className={activePage === "wishlist" ? activeLinkClass : inactiveLinkClass}>
          Wishlist
        </Link>

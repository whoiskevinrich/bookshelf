...
export function ShelfEmptyState({ onAdd }: ShelfEmptyStateProps) {
  return (
    <div className="text-center py-20">
      ...
      <button
        onClick={onAdd}
        className="text-sm bg-gray-900 text-white px-5 py-2.5 rounded-lg hover:bg-gray-700 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200 transition-colors"
      >
        Add your first book →
      </button>
    </div>

  ...
  return (
    <div className="min-h-screen bg-paper-100 dark:bg-slate-900 transition-colors">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="bg-paper-200 dark:bg-slate-800 rounded-2xl p-4 sm:p-8">
          <p className="text-sm text-slate-600 dark:text-slate-400 tracking-wide mb-6 text-center">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-sm text-slate-600 dark:text-slate-400">Ready to track your books?</p>
          <Link
            to="/auth/signup"
